/**
 * Structured Logger for Worker App
 *
 * Self-contained copy of the structured JSON logger used by the API app.
 * Produces consistent JSON output with timestamps, severity levels,
